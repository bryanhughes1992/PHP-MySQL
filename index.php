...
<html lang="en">
  ...
  <body>
    <div class="master-container">
      <h1 class="title">PHP AND MYSQL</h1>
      <div class="m-1">
          ...
          <tbody>
            <?php foreach ($clientCars as $car) { ?>
              <tr>
                ...
                <td><?= $car->year; ?></td>
                <td>
                  <form action="./pages/UpdateCar.php" method="post">
                    <input type="hidden" name="id" value="<?= $car->id; ?>" />
                    <input type="submit" class="button btn btn-primary" name="updateCar" value="Update" />
                  </form>
                </td>
                <td>
                  <form action="./pages/DeleteCar.php" method="post">
                    <input type="hidden" name="id" value="<?= $car->id; ?>" />
        ...
        <a href="./pages/AddCar.php" id="btn_addCar" class="btn btn-success btn-lg float-right">Add Car</a>
      </div>
    </div>
  </body>
</html>